...
{
    public class rec_clifor_righdoc
    {
        // CHIAVE|COD_DITTA|NUM_REG|PRG_RIGA|COD_RIGA|DES_RIGA|COD_UM|QTA|PRZ_LORDO|PRZ_NETTO|IMPORTO|SC_1|SC_2|DATA_CONFERMA|TIPO_CLIFOR|COD_CLIFOR|DAT_ULT_MOD
